...
import language from '.js/layouts/index.js'; // { en, ru }
import Key from '.js/utils/Key.js';

const main = create('main', '',
[create('h1', 'title', 'Virtual Keyboard'),
    create('h3', 'subtitle', 'The virtual keyboard was created in Windows OS'),
    create('p', 'hint', 'To switch the language press Left Shift+Alt')]);
